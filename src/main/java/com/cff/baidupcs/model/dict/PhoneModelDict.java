...
public class PhoneModelDict {
	public static String[] phoneModelDataBase = new String[] { "1501_M02", // 360
																			// F4
			"1503-M02", // 360 N4
			"1505-A01", // 360 N4S
			...
			"NX563J", // 努比亚Z17
			"Nexus 4", "Nexus 5X", "Nexus 6", "Nexus 6P", "Nexus 7", "Nexus 9", "Nokia_X", // Nokia
																							// X
			...
			"VERTU Ti", // Vertu Ti
			"VIE-AL10", // 华为 P9 Plus
			"VIVO X20", "VIVO X20A", "W909", // 金立 天鉴 W909
			"X500", // 乐视 乐1S
			"X608", // 乐视 乐1
			"X800", // 乐视 乐1Pro
			"X900", // 乐视 乐Max
