...
public class TestRsa {
	...
	public static RSAPublicKey generateRSAPublicKey(byte[] modulus, BigInteger publicExponent) throws Exception {
		...
		RSAPublicKeySpec pubKeySpec = new RSAPublicKeySpec(new BigInteger(modulus), publicExponent);
		try {
			return (RSAPublicKey) keyFac.generatePublic(pubKeySpec);
		} catch (InvalidKeySpecException ex) {
			throw new Exception(ex.getMessage());
	...
	public static String encrypt(String data, String publicKey) throws Exception {
		RSAPublicKey pubKey = generateRSAPublicKey(new BigInteger(publicKey, 16).toByteArray(),
	...
	public static void main(String[] args) throws Exception {
		...
		// TestRsa.generateKeyPair().getPublic();
